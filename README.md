...
**This Repository** provides a ROS 2 + Gazebo-based simulator for **Int-Ball2**. It simulates Int-Ball2's behavior in the ISS/JEM environment with user-developed programs.



## Key Features
- **ROS 2 / Gazebo Simulator**: Simulates Int-Ball2's behavior in the ISS/JEM environment using ROS 2 Jazzy and Gazebo Harmonic. It includes plugins simulating the airflow, sensor data acquisition, and actuator control interfaces for Int-Ball2 (SLAM is not simulated).
