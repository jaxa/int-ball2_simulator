...
public:
    ...
    static const QColor LED_COLOR_CAMERA_AND_MICROPHONE;
    static const QColor LED_COLOR_CAMERA;
    static const QColor LED_COLOR_MICROPHONE;
    static const QColor LED_COLOR_WITHOUT_ALL;
    static const QColor LED_COLOR_NONE;
